...
LIBNAME CS '/folders/myfolders/file_data/SASCaseStudies';
/**************************** Importing the files **************************************/
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/POS_Q1.csv' out=POS_Q1 dbms=csv replace;
guessingrows=5000;
run;
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/POS_Q2.csv' out=POS_Q2 dbms=csv replace;
guessingrows=5000;
run;
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/POS_Q3.csv' out=POS_Q3 dbms=csv replace;
guessingrows=5000;
run;
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/POS_Q4.csv' out=POS_Q4 dbms=csv replace;
guessingrows=5000;
run;
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/Laptops.csv' out=Laptops dbms=csv replace;
guessingrows=5000;
run;
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/London_postal_codes.csv' out=London_postal_codes dbms=csv replace;
guessingrows=5000;
run;
PROC IMPORT DATAFILE='/folders/myfolders/file_data/SASCaseStudies/Store_locations.csv' out=Store_Locations dbms=csv replace;
guessingrows=5000;
run;
...
/****************** QUESTION 1 ******************/
ods html file='/folders/myfolders/file_data/SASCaseStudies/q1.xls';
PROC SQL;
create table q1 as
...
ods html file='/folders/myfolders/file_data/SASCaseStudies/q2.xls';
proc sql;
create table q3 as
