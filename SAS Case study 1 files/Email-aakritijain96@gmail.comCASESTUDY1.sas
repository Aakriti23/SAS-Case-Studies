  /*************************** CASE STUDY 1 ********************************************/
 /************* Aakriti Jain-aakritijain96@gmail.com *************************/


libname cs '/folders/myfolders/file_data/SASCaseStudies/SAS Case study 1 files';

proc import datafile='/folders/myfolders/file_data/SASCaseStudies/SAS Case study 1 files/flights.csv' out=flights dbms=csv replace;
guessingrows=10000;
run;

proc import datafile='/folders/myfolders/file_data/SASCaseStudies/SAS Case study 1 files/weather.csv' out=weather dbms=csv replace;
guessingrows=10000;
run;
proc import datafile='/folders/myfolders/file_data/SASCaseStudies/SAS Case study 1 files/planes.csv' out=planes dbms=csv replace;
guessingrows=10000;
run;
...
Month=month(date);
Day=day(Date);
Hour=hour(sched_dep_time);         /****forming hour and hour2 to solve question6***/
...
/***************** QUESTION 2 ************************/
/***************** Removed the variable speed and observations with missing values ******************/
data planes;
set planes;
drop speed;
...
/********************** Exploring the Data ******************************/
/******** QUESTION 5-FINDING THE BUSIEST ROUTE******/
/******CONCATENATING ORIGIN-DEST VARIABLES***************/
data flights1;
set flights;
...
/************ QUESTION-5 (A) *******************/
/****** BUSIEST ROUTES-"JFK LAX","LGA ATL"	,"LGA ORD"	,"JFK SFO"	,"LGA CLT"******/
...
QUIT;
/************* QUESTION 7 (B) ******************************/
/************* Least number of delays=LGA Airport ***************/
PROC SQL;
...
QUIT;
/************* QUESTION 7 (C) ******************************/
/****************** JAC-has the hightest number of delays*****************************/
PROC SQL;
...
/***************** Question 8-(b) *************************/
/***************** Changing the weather variables to compare with the departure delay *****************/
data joined;
set joined;
